...
public class BuiltIn extends Library {
	...
	public boolean comma_2(Term arg0, Term arg1) {
		...
		engineManager.pushSubGoal(DefaultClauseInfo.extractBody(s));
		return true;
	}
	...
	public boolean $call_1(Term goal) {
		...
		engineManager.pushSubGoal(DefaultClauseInfo.extractBody(goal));
		return true;
	}
	...
	public boolean $op_3(Term arg0, Term arg1, Term arg2){
		 ...
		 */
		if (!(arg0 instanceof Number) || !arg1.isAtom() || !arg2.isAtom()) {
			return false;
		} else {
