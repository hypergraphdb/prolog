...
public class EngineManager implements java.io.Serializable {
	...
	private ClauseStoreManager clauseStoreManager = new ClauseStoreManager();
...
//	}
	...
	ClauseStore buildClauseStore(Term goal, List<?> varsList)
	{
		return clauseStoreManager.buildClause(this.mediator, goal, varsList);
	}
